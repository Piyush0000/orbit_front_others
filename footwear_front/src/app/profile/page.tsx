                ...
                {activeTab === 'dashboard' && (
                    <>
                        ...
                        <p style={{ marginBottom: '2rem', color: '#666' }}>
                            Hello, <strong>{user.name}</strong>! From your My Account Dashboard you have the ability to view a snapshot of your recent account activity and update your account information.
                        </p>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
                            ...
                            >
                                ...
                                <h3 style={{ textTransform: 'uppercase', marginBottom: '0.5rem' }}>Personal Details</h3>
                                <p style={{ fontSize: '0.9rem', color: '#666' }}>Edit name, email, phone, and address.</p>
                            </div>
                            ...
                            >
                                ...
                                <h3 style={{ textTransform: 'uppercase', marginBottom: '0.5rem' }}>Orders</h3>
                                <p style={{ fontSize: '0.9rem', color: '#666' }}>Check status of recent orders.</p>
                            </div>
                            ...
                            >
                                ...
                                <h3 style={{ textTransform: 'uppercase', marginBottom: '0.5rem' }}>Addresses</h3>
                                <p style={{ fontSize: '0.9rem', color: '#666' }}>Manage shipping and delivery addresses.</p>
                            </div>
                        </div>

                        {/* Recent Order Preview */}
                        <div style={{ marginTop: '4rem' }}>
                            <h2 style={{ fontSize: '1.2rem', textTransform: 'uppercase', marginBottom: '1.5rem', borderBottom: '1px solid #eee', paddingBottom: '0.5rem' }}>Recent Order</h2>
                            {orders.length > 0 && (
                                <div style={{ border: '1px solid #eee', borderRadius: '8px', padding: '1.5rem', background: 'white' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                                        <div>
                                            <span style={{ fontWeight: 'bold' }}>{orders[0].id}</span>
                                            <span style={{ margin: '0 0.5rem', color: '#ccc' }}>|</span>
                                            <span style={{ color: '#666' }}>{orders[0].date}</span>
                                        </div>
                                        <span style={{
                                            padding: '0.25rem 0.5rem',
                                            borderRadius: '4px',
                                            fontSize: '0.8rem',
                                            background: orders[0].status === 'Delivered' ? '#dcfce7' : '#fff7ed',
                                            color: orders[0].status === 'Delivered' ? '#166534' : '#c2410c',
                                            fontWeight: 'bold'
                                        }}>
                                            {orders[0].status}
                                        </span>
                                    ...
                                    <button
                                        onClick={() => setActiveTab('orders')}
                                        style={{ textDecoration: 'underline', border: 'none', background: 'none', cursor: 'pointer', padding: 0, fontWeight: 'bold' }}
                                    >
                                        View All Orders
                                    </button>
                                </div>
                        ...
                        <div className={styles.card}>
                            <div className={styles.formGrid}>
                                ...
                                <div className={styles.inputGroup} style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
                                    <h3 style={{ fontSize: '1.1rem', marginBottom: '0.5rem', borderBottom: '1px solid #eee', paddingBottom: '0.5rem' }}>Address</h3>
                                </div>
