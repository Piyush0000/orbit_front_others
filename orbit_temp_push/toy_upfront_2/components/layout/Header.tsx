        ...
        <div className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100/50 shadow-sm transition-all duration-300">
            ...
            <div className="container mx-auto px-4 py-4 relative">
                <div className="flex items-center justify-between gap-4">
                    ...
                    {/* Logo */}
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 lg:static lg:translate-x-0 lg:translate-y-0 w-auto flex justify-center z-0">
                        <Link href="/" className="group flex items-center gap-2">
                            <div className="bg-primary/10 p-2 rounded-xl rotate-3 group-hover:rotate-6 transition-transform">
                                <span className="text-2xl">🧸</span>
                            </div>
                            <span className="text-2xl sm:text-3xl font-extrabold text-foreground font-display tracking-tight leading-none whitespace-nowrap">
